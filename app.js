...
UIController=(function()
{
	...
	return{
		...
		displaymonth:function()
		{
			...
			now=new Date();
			monlist=['JAN','FEB','MAR','APR','MAY','JUN','JULY','AUG','SEP','OCT',
					 'NOV','DEC']
			mon=now.getMonth();
			year=now.getFullYear();
			var name=prompt("Enter your Name")
			document.querySelector(DOMstrings.datelabel).textContent="Hello, "+name+" Available Budget in "+monlist[mon]+' '+year;
		},
